...
public class CameraManager {
    ...
    private Camera getCameraInstance() {
    	/*
    	 * Change this to detect front and back cameras
    	 * */
        
    	int numberOfCameras = Camera.getNumberOfCameras();
        if (numberOfCameras == 0) {
          Log.w(CameraManager.class.getSimpleName(), "No cameras!");
          return null;
        }
        ...
        try {
	        if (i < numberOfCameras) {
	          Log.i(CameraManager.class.getSimpleName(), "Opening camera #" + i);
	          c = Camera.open(i);
	          
	        } else {
	          Log.i(CameraManager.class.getSimpleName(), "No camera facing back; returning camera #0");
	          c = Camera.open(0);
